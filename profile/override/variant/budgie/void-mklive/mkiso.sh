...
#        ;;
        ...
        ;;
        fluxbox)
            PKGS="$PKGS $XORG_PKGS lightdm lightdm-gtk-greeter fluxbox gnome-themes-standard gnome-keyring network-manager-applet gvfs-afc gvfs-mtp gvfs-smb udisks2 firefox"
            SERVICES="$SERVICES dbus lightdm NetworkManager polkitd"
